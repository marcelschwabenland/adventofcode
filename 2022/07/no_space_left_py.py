...
def part_1(dir_sizes: dict, threshold: int) -> int:
    return sum(dir_size for dir_size in dir_sizes.values()
               if dir_size < threshold)


def part_2(dir_sizes: dict, max_disk_space: int,
           required_disk_space: int) -> None:
...
if __name__ == "__main__":
    with open("C:\\Users\\schwa\\Projekte\\adventofcode\\2022\\07\\input.txt",
              "r",
              encoding="utf-8") as puzzle_input:
